...
export default function ProjectDetail() {
  ...
  const userIcons = [
    ...
    { icon: <Users size={16} />, label: "Office Of Surat Thani Central Rubber Market" },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="bg-white rounded-2xl shadow p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-sm text-gray-600 font-medium">Select More Images</p>
              <button
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-2 border-b pb-1">Technology Stack</h3>
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-2 border-b pb-1">Company</h3>
